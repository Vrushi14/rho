...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "We reserve the right to update this policy at any time. Material changes will be highlighted on our homepage and the 'Last updated' date at the top of this page will be revised.",
    ],
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-12 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="bg-primary/5 border border-primary/20 rounded-2xl p-6 mb-8 text-sm text-muted-foreground leading-relaxed">
          Your privacy matters to us. This policy explains what data Realgameapps collects when you visit <strong className="text-foreground">realgameapps.com</strong>, how we use it, and the rights you have over it.
        </motion.div>
